...
async function wawe(buff) {
	let b = await toAudio(buff)
    fs.writeFileSync("./temp.mp4", b);
...
module.exports = { wawe, MediaUrls, createInteractiveMessage, AudioMetaData, ffmpeg, cutAudio, cutVideo, toAudio, toPTT };
